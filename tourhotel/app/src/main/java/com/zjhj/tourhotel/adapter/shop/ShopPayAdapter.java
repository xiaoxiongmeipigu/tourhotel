 ...
 */
public class ShopPayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ShopPayAdapter(Context context, List<IndexData> list) {
