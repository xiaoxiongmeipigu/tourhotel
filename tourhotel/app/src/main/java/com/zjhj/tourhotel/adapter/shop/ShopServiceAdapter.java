 ...
 */
public class ShopServiceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ShopServiceAdapter(Context context, List<IndexData> list) {
