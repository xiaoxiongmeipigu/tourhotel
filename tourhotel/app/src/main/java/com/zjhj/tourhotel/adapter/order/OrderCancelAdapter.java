...
public class OrderCancelAdapter extends RecyclerView.Adapter<OrderCancelAdapter.ViewHolder> {
    ...
    public OrderCancelAdapter(Context context, List<MapiOrderResult> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_order_cancel, parent, false));
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.contentTv.setText("取消原因："+(TextUtils.isEmpty(itemResult.getRevoke_reason())?"":itemResult.getRevoke_reason()));
