 ...
 */
public class ShopSpotsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ShopSpotsAdapter(Context context, List<IndexData> list) {
