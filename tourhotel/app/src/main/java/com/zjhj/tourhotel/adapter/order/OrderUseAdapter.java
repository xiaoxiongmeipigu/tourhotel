 ...
 */
public class OrderUseAdapter extends RecyclerView.Adapter<OrderUseAdapter.ViewHolder> {
    ...
    public OrderUseAdapter(Context context, List<MapiOrderResult> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_order_use, parent, false));
    }
