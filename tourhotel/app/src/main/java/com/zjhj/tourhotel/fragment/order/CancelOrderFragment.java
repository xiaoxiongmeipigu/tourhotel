...
import com.zjhj.tourhotel.adapter.order.OrderCancelAdapter;
...
public class CancelOrderFragment extends BaseFrag {
    ...
    private void initView() {
        ...
        mAdapter = new OrderCancelAdapter(getActivity(), mList);
    ...
    public void load() {
        showLoading();
        ItemApi.orderindex(getActivity(),"4", pageIndex + "", pageNum + "",new RequestPageCallback<List<MapiOrderResult>>() {
            @Override
    ...
    private void pass(){
        ...
        showLoading();
        ItemApi.orderadopt(getActivity(), orderResult.getId(),"2", new RequestCallback() {
            @Override
