...
//                return super.parseNetworkResponse(response);
    ...
    public void call(final Activity act, final String url, final Map<String, String> params,
        ...
        if(null!=userSP.getUserBean()){
            ...
            params.put(Constants.Uid, TextUtils.isEmpty(userSP.getUserBean().getMerchant_id())?"":userSP.getUserBean().getMerchant_id());
            DebugLog.i("token=>"+userSP.getUserBean().getToken());
            DebugLog.i("userSP.getUserBean().getUid()=>"+userSP.getUserBean().getMerchant_id());
        }
        if (params != null)
...
////                }
     ...
     * @param fail
     */
    public void uploadShopFile(final Activity activity, String url, File file,String id,String type, final MapiSuccessResponse response, final MapiFailResponse fail) {
        RequestParams params = new RequestParams();
        params.addBodyParameter("file", file);
